...
**Tested on:**
- CPU: ~50-100ms per image (depending on device)
- GPU: ~10-30ms per image (mobile GPU with FP16)

**Recommended batch size:**
- Mobile: 1 (single image inference)
- Server: 1-32 (depending on available memory)
